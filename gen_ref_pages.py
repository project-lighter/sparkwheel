...
def generate_api_reference(src: Path, exclude: list[str]) -> None:
    ...
    Args:
        ...
        exclude (list): A list of module to exclude from the API documentation. Use Python module notation (e.g. `sparkwheel.utils.logging`).
    """
    package = src.name
...
src_path = Path(__file__).parent.parent / "src" / "sparkwheel"
